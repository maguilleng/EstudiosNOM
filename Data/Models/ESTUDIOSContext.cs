...
{
    public partial class ESTUDIOSContext : DbContext
    {
        public ESTUDIOSContext()
        {
        }

        public ESTUDIOSContext(DbContextOptions<ESTUDIOSContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server = LAPTOP-T2N83NE5\\SQLEXPRESS; Database=ESTUDIOS; Trusted_Connection=True; MultipleActiveResultSets=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Empresa>(entity =>
            {
                ...
                entity.Property(e => e.Proceso).HasMaxLength(200);
                ...
                entity.Property(e => e.ResponsableInforme).HasMaxLength(150);
            });
            ...
            modelBuilder.Entity<EvAycAmbientermico>(entity =>
            {
                ...
                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_A__76B294D136038015")
                    .IsUnique();
            ...
            modelBuilder.Entity<EvAycAmbientesonoro>(entity =>
            {
                ...
                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_A__76B294D1AEFF069D")
                    .IsUnique();
            ...
            modelBuilder.Entity<EvAycIluminacion>(entity =>
            {
                ...
                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_I__76B294D12BD15861")
                    .IsUnique();

                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_I__76B294D1756D40A9")
                    .IsUnique();

                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_I__76B294D1A1C86640")
                    .IsUnique();
            ...
            modelBuilder.Entity<EvAycVibracion>(entity =>
            {
                ...
                entity.HasIndex(e => e.Idtarea, "UQ__EV_AYC_V__76B294D1DCFF47E3")
                    .IsUnique();
            ...
            modelBuilder.Entity<NomResultado>(entity =>
            {
                ...
                entity.HasOne(d => d.IdtareaNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_NOM_036_RESULTADOS_TAREAS");
            });
